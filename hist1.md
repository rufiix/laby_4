Nowa etykieta "User story" ma reprezentować potrzeby użytkownika,
przedstawiać funkcjonalność lub wartość, którą użytkownik chce osiągnąć. "User
story" definiuje cel z perspektywy użytkownika i opisuje, dlaczego dana funkcja jest
ważna dla końcowego odbiorcy.
 **Label name:** User story
**Description:** Description of user need.# Biletomat ZTM
